...
const PopupClaim = ({ onClose, additionalData}) => {
    ...
    return (
        ...
        {showCongratulations ? 
        (
            <div className="popup-container" style={popupCongratulationsFailStyle}>
                    ...
                    <div className="popup-content" style={popupContentStyle}>
                        <div className="flex items-center flex-col">
                            <Image
                                ...
                                height={48} 
                            />
                            <p className='mt-5 text-sm' style={paragraphStyle}>Sorry!</p>
                            <p>The claim code doesn't match! Please try again!</p>
                            <div className="flex items-center justify-center">
                                <Button className="mt-5 w-200 h-10" onClick={retryClaim}>Retry
                                </Button>
                            </div>
                        </div>
                    </div>
            ...
            (
                <div className="popup-container" style={popupContainerStyle}>
                    <div className="popup-content" style={popupContentStyle}>
                            <p className='mt-5 text-sm' style={paragraphStyle}>Enter Claim Code</p>
                            <input
                                type="text"
                                value={claimCode}
                        ...
                        <div className="flex mt-35 justify-between ">
                            <Button className="w-30 mt-8 ml-8" asChild onClick={handleConfirmClaim}>
                            <a>Confirm</a>
                            </Button>
